...
return new class extends Migration
{
    ...
    {
        // 1. Adicionar color_index na tabela agendamentos
        ...
        // 4. Remover color_index da tabela agendamentos_recorrencia
    ...
    {
        // 1. Adicionar color_index de volta na tabela recorrencia
        Schema::table('agendamentos_recorrencia', function (Blueprint $table) {
        ...
        // 3. Remover color_index da tabela agendamentos
        Schema::table('agendamentos', function (Blueprint $table) {
